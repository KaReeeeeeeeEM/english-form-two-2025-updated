...
├── english-form-two-2025-updated.db                    # SQLite database (pipeline state)
├── english-form-two-2025-updated.pdf                   # Original source PDF
...
```json
{
  "abducted": {
    "word": "abducted",
    "definition": "taken away illegally by force",
    "variations": ["abduct","abducted","abduction"],
    "emoji": "🚨⚠️"
  }
}
```
...
| Original PDF | `english-form-two-2025-updated.pdf` |
| Pipeline database | `english-form-two-2025-updated.db` (SQLite) |
